...
| net        | 58/106    | 55%  | high     | **MEASURED 2026-07-17.** pre-session 44 (oom 3, timeout 12). session: **44->58, oom 3->0, timeout 12->4**. Socket DOES extend Duplex already — that blocker is stale. dns-lookup lever DONE. end()-before-connect now defers FIN to 'connect' (was dropped). remaining 4 timeouts: write-slow, listen-fd0, local-address, connect-options-port |

...
| worker     | 37/53     | 70%  | low      | real pthread+isolate impl; uncaught-exception propagation works single-level AND nested (test-worker-nested-uncaught verified). remaining: heap-snapshot, wasm transfer, type-check/workerdata validation, esm-missing-main, event |
